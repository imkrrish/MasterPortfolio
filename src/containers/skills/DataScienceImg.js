...
export default class DataScienceImg extends Component {
  render() {
    ...
    return (
      <svg id="96306a94-3bea-4326-87c9-b4488db4c6c8" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="1097.1"
        height="807.9" viewBox="0 0 1097.1 807.9">
        <title>android</title>
        <path
          d="M63.3,476c17.36,74.2,54.11,138.34,112.19,169.43,120.7,64.61,392.91,31.29,596.07-7a465.21,465.21,0,0,0,264.54-151.23Z"
          transform="translate(-51.45 -46.05)" fill="#0E6BA8" opacity="0.1" />
        <path
        ...
        <g opacity="0.1">
          <path d="M729,669.33s28.2-69.5,80.86-95.28A113.65,113.65,0,0,0,861.47,524,191.13,191.13,0,0,0,874.4,491.5"
            transform="translate(-51.45 -46.05)" fill="none" stroke="#00072D" stroke-miterlimit="10"
            stroke-width="2" />
          <path d="M907.49,475.05c-5.49,6.9-33.9,17-33.9,17s3.42-30,8.91-36.85a16,16,0,0,1,25,19.88Z"
            transform="translate(-51.45 -46.05)" fill="#0E6BA8" />
        ...
        <path
          ...
          transform="translate(-51.45 -46.05)" fill="#0E6BA8" opacity="0.1" />
        <rect x="365.51" y="184.9" width="7" height="99" fill="#00072D" />
        <rect x="365.51" y="317.9" width="7" height="56" fill="#00072D" />
        <rect x="370.51" y="87.9" width="315" height="684" rx="47.1" ry="47.1" fill="#00072D" />
        <rect x="370.51" y="119.9" width="315" height="623" rx="47.1" ry="47.1" fill="#0E6BA8" />
        ...
        <rect x="454.01" y="569.46" width="65" height="3" fill="#00072D" />
        <rect x="543.01" y="569.46" width="43" height="3" fill="#00072D" />
        <rect x="397.01" y="569.46" width="43" height="3" fill="#00072D" />
        <rect x="611.01" y="569.46" width="43" height="3" fill="#00072D" />
      </svg>
    );
  }
}
